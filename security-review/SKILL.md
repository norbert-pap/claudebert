...
- **At start:** Read `.claudebert/session-state.md` if it exists — code-review may have flagged security items to investigate deeper
- **At end:** Append security findings summary to the session state file
