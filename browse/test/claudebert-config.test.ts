/**
 * Tests for bin/claudebert-config bash script.
 *
...
const SCRIPT = join(import.meta.dir, '..', '..', 'bin', 'claudebert-config');
...
beforeEach(() => {
  stateDir = mkdtempSync(join(tmpdir(), 'claudebert-config-test-'));
});
