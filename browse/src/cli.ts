/**
 * claudebert CLI — thin wrapper that talks to the persistent server
 *
 * Flow:
 *   1. Read .claudebert/browse.json for port + token
...
async function main() {
  ...
  if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
    console.log(`claudebert browse — Fast headless browser for AI coding agents
