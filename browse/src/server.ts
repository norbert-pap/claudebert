/**
 * claudebert browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.claudebert/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.claudebert/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['claudebert browse — headless browser for AI agents', '', 'Commands:'];
